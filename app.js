...
const DEFAULT = {
  ...
  achievements: [
    ...
    { text: 'Спроектировала и вывела в прод 4 приложения полного цикла: архитектура, интерфейс, серверная часть, база данных, тестирование и автодеплой — все доступны онлайн.' },
    { text: 'Реализовала fullstack-интеграцию с LLM через serverless-функцию: ключи изолированы в окружении, ответ модели валидируется и приводится к строгому формату.' },
    ...
    { text: 'Волонтёр международных игр «Дети Азии», фестиваля «Муус устар» с первого сезона и «Игр Манчаары»: работа в команде на массовых мероприятиях, где нельзя подвести.' }
  ],
  skills: [
  ...
  exp: [
    {
      ...
      meta: '4 года',
      desc: 'Обучила более 200 учеников: C# и Unity, C++ (SFML), Python, веб-разработка, Roblox Studio, разработка визуальных новелл. Разработка авторских методик и учебных материалов, диагностика уровня групп, анализ результатов и корректировка программы, сопровождение проектных работ до защиты, создание графики и спрайтов для учебных игр.'
    },
    {
      title: 'Волонтёр международных и республиканских мероприятий',
      meta: 'Регулярно, несколько лет',
      desc: 'Международные спортивные игры «Дети Азии», фестиваль «Муус устар» — с самого первого сезона, Спортивные игры народов Якутии «Игры Манчаары». Работа в команде на массовых мероприятиях: сопровождение участников и гостей, координация на площадках, оперативное решение задач в меняющейся обстановке, высокие требования к ответственности и дисциплине.'
    },
    {
      title: 'Разработчик программного обеспечения (проектная работа)',
      meta: '2024 — настоящее время',
      desc: 'Полный цикл разработки веб- и десктоп-приложений: проектирование архитектуры, типизация, интеграция с внешними и AI-API, serverless-функции, работа с PostgreSQL, тестирование, настройка CI/CD и выпуск в продакшн, техническая документация.'
    },
    {
...
const PRESETS = {
  ...
  frontend: {
    ...
    data: () => ({
      ...
      about: 'Frontend-разработчик с широким техническим бэкграундом: React, TypeScript, Vite, адаптивная вёрстка, работа с REST и AI-API, serverless-функции, PostgreSQL, автодеплой на Vercel. До веба писала на C#, Unity и C++, поэтому понимаю программирование глубже уровня фреймворка. Четыре года преподавала и обучила более 200 учеников — умею объяснять решения, писать документацию и проектировать интерфейсы, понятные с первого взгляда. Интерфейсы собираю сама в Figma, графику рисую в Krita.',
      skills: [
