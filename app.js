...
const PRESETS = {
  ...
  gamedev: {
    label: 'Unity / Game Developer (Mytona)',
    data: () => ({
      ...structuredClone(DEFAULT),
      theme: 'pro',
      role: 'Unity-разработчик (C#) · Опыт в геймдеве и создании визуального контента',
      city: 'Якутск',
      pitch: [
        { v: 'Unity', l: 'C#, игровая логика' },
        { v: '200+', l: 'учеников по геймдеву' },
        { v: '2D', l: 'спрайты и анимация сама' },
        { v: 'Якутск', l: 'без релокации' }
      ],
      hobby: 'Рисование и цифровая графика · Разработка визуальных новелл · Слежу за развитием ИИ и новыми инструментами · Пишу программы под свои задачи · Рукоделие · Наращивание ногтей · Хорошо разбираюсь в интернет-культуре и мемах',
      about: 'Разрабатываю игры на Unity (C#) и C++/SFML полным циклом - от игровой логики и архитектуры до интерфейса и визуального контента, который рисую сама в Krita. За плечами несколько завершённых проектов: игры, визуальные новеллы, обучающие приложения на игровых движках, каждый доведён до рабочего состояния, а не заброшен на полпути. Уверенно работаю с ИИ и встраиваю нейросети в свои продукты через serverless-функции с валидацией результата. Быстро осваиваю новое и довожу начатое до конца: за 4 года преподавания на основе Unity, C# и Roblox Studio обучила больше 200 учеников геймдев-направлениям. Живу в Якутске.',
      achievements: [
        { text: 'Разработала несколько игровых проектов на Unity (C#) и SFML (C++): игровая логика, сцены, интерфейс. Спрайты нарисовала и анимировала сама в Krita - закрываю связку программист плюс 2D-художник, которую обычно делят двое.' },
        { text: 'Сделала визуальные новеллы, использованные как учебный материал: опыт работы со сценарной структурой, ветвлением диалогов и UI повествовательных игр.' },
        { text: 'Обучила геймдев-направлениям (Unity/C#, Roblox Studio) более 200 учеников за 4 года. Умею объяснять технические концепции - пригодится в работе с гейм-дизайнерами и на код-ревью джуниоров.' },
        { text: 'Встроила нейросеть в собственный продукт через serverless-функцию с валидацией ответа: понимаю, как безопасно интегрировать AI-инструменты в продакшн, а не просто дёргать API.' },
        { text: 'Выпустила 4 приложения полного цикла - от архитектуры до автодеплоя, включая работу с базой данных и голосовым интерфейсом (Aurora).' },
        { text: 'Пишу инструменты под себя, когда готового решения нет. Рутину предпочитаю автоматизировать, а не терпеть.' }
      ],
      skills: [
        { name: 'ГЕЙМДЕВ', level: -1 },
        { name: 'Unity (C#)', level: 0 },
        { name: 'C++ / SFML', level: 0 },
        { name: 'Игровая архитектура и логика', level: 0 },
        { name: 'Геймдизайн, сценарии и ветвление диалогов', level: 0 },
        { name: '2D-графика и анимация (Krita)', level: 0 },
        { name: 'Работа со спрайтами и UI игр', level: 0 },
        { name: 'Roblox Studio', level: 0 },
        { name: 'РАЗРАБОТКА (ДОПОЛНИТЕЛЬНО)', level: -1 },
        { name: 'TypeScript / JavaScript, React', level: 0 },
        { name: 'Python', level: 0 },
        { name: 'SQL / PostgreSQL', level: 0 },
        { name: 'REST API, serverless, LLM API', level: 0 },
        { name: 'Git, CI/CD, деплой', level: 0 },
        { name: 'ЯЗЫКИ', level: -1 },
        { name: 'Английский - чтение технической документации', level: 0 },
        { name: 'СОФТ-СКИЛЛЫ', level: -1 },
        { name: 'Быстрое обучение новому', level: 0 },
        { name: 'Доведение проектов до конца', level: 0 },
        { name: 'Преподавание и менторство', level: 0 },
        { name: 'Работа в команде при меняющихся задачах', level: 0 }
      ],
      projects: [
        { title: 'Игры и визуальные новеллы - Unity (C#), SFML (C++)', desc: 'Игровая логика, сцены, интерфейс. Спрайты и анимацию рисовала сама в Krita. Использовались как учебные материалы на занятиях по геймдеву.', tags: 'C#, Unity, C++, SFML, Krita, геймдизайн', link: '' },
        { title: 'LexiCard - платформа изучения языка с AI-генерацией контента', desc: 'React и TypeScript на клиенте, serverless-функция на сервере, нейросеть для генерации учебных наборов. Геймификация: таймер, звуковая обратная связь, повтор ошибок. Методика построена на преподавательском опыте.', tags: 'React, TypeScript, Serverless, LLM API', link: 'github.com/Evil-Pinguin/lexicard' },
        { title: 'Aurora - голосовой помощник для компьютера', desc: 'Ассистент для автоматизации рутины голосом и командами. Сценарий взаимодействия продуман так, чтобы работало без инструкции.', tags: 'Python, автоматизация, голосовой интерфейс', link: '' },
        { title: 'Другие проекты', desc: 'EduQuiz Pro - платформа квизов с конструктором вопросов. Обучающий сайт по основам Linux. Личные веб-инструменты: то-ду лист, генератор резюме.', tags: 'React, JavaScript, Linux', link: 'my-edu-quiz.vercel.app' }
      ],
      exp: [
        { title: 'Разработка игр (самостоятельные проекты)', meta: '2024 - настоящее время', desc: 'Разработка игровой логики, сцен и интерфейса на Unity (C#) и SFML (C++). Полный цикл создания визуальных новелл: сюжет, механика, интерфейс, отрисовка и анимация спрайтов в Krita. Проекты использовались как учебный материал на занятиях по геймдеву.' },
        { title: 'Преподаватель программирования и информатики - 2 школы дополнительного образования', meta: '4 года', desc: 'Обучила более 200 учеников разработке на C# и Unity, C++ (SFML), Roblox Studio, созданию визуальных новелл. Автор собственных методик и учебных материалов. Вела проектные работы учеников до защиты, включая геймдев-проекты.' },
        { title: 'Разработчик ПО (самостоятельные проекты)', meta: '2024 - настоящее время', desc: 'Полный цикл разработки веб-сервисов: архитектура, типизация, внешние и AI-API, serverless-функции, PostgreSQL, тесты, CI/CD, деплой в продакшн.' },
        { title: 'Волонтёр международных и республиканских мероприятий', meta: 'Регулярно, несколько лет', desc: 'Игры «Дети Азии», фестиваль «Муус устар» с первого сезона, «Игры Манчаары». Координация на площадках, работа в команде при быстро меняющихся задачах.' },
        { title: 'Педагогический институт - высшее образование', meta: 'Диплом', desc: 'Педагогика: методология обучения, проектирование систем оценивания.' }
      ]
    })
  },
