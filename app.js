...
const PRESETS = {
  ...
  research: {
    label: 'Аналитик / количественные исследования',
    data: () => ({
      ...structuredClone(DEFAULT),
      theme: 'pro',
      role: 'Аналитик данных · Методолог образовательных исследований · 6 лет работы с данными и оценкой результатов',
      city: 'Якутск',
      email: 'anzhelina.nikolaeva@gmail.com',
      pitch: [
        { v: '200+', l: 'человек в выборке' },
        { v: '4 года', l: 'сбора и анализа данных' },
        { v: '2', l: 'инструмента сбора данных' },
        { v: 'Якутск', l: 'без релокации' }
      ],
      hobby: 'Слежу за развитием ИИ и аналитических инструментов · Создание сайтов и веб-инструментов · Разработка методик обучения · Цифровая графика',
      about: 'Проектирую методики оценки и анализирую результаты на выборках от 200+ человек. 4 года выстраивала систему оценивания в двух школах допобразования: собирала данные о прогрессе учеников, разбирала типовые ошибки и корректировала подход по итогам анализа. Работаю с SQL и Python для сбора и обработки данных, строю инструменты аналитики сама - EduQuiz Pro считает и агрегирует результаты тестирования. Понимаю, как поставить измеримую гипотезу, собрать данные и довести исследование до практического вывода. Живу в Якутске.',
      achievements: [
        { text: 'Спроектировала и внедрила систему оценки результатов для 200+ учеников за 4 года в двух образовательных организациях: разработала критерии, собирала данные о прогрессе, корректировала методику по итогам анализа.' },
        { text: 'Подготовила учениц-победительниц муниципальной олимпиады по биологии и экологии - опыт сопровождения исследовательских работ от гипотезы до защиты на научных конференциях.' },
        { text: 'Построила инструмент сбора и анализа результатов тестирования EduQuiz Pro: конструктор вопросов, валидация данных на входе, автоматический подсчёт и агрегация результатов.' },
        { text: 'Работаю с SQL и PostgreSQL, обрабатываю и структурирую данные на Python, готовлю отчётность и защищаю выводы перед аудиторией.' },
        { text: 'Также имею опыт разработки ПО полного цикла (React, TypeScript, Python, C#) из самостоятельных проектов 2024-2025.' }
      ],
      skills: [
        { name: 'АНАЛИТИКА И ДАННЫЕ', level: -1 },
        { name: 'SQL / PostgreSQL', level: 0 },
        { name: 'Python: обработка и анализ данных', level: 0 },
        { name: 'Проектирование систем оценивания', level: 0 },
        { name: 'Сбор и анализ количественных результатов', level: 0 },
        { name: 'Работа с выборками от 200 наблюдений', level: 0 },
        { name: 'Статистика: среднее, распределение, выбросы, динамика', level: 0 },
        { name: 'Excel / Google Sheets: формулы, сводные таблицы', level: 0 },
        { name: 'Проектирование анкет, тестов, форм сбора данных', level: 0 },
        { name: 'Аналитическая отчётность и презентация выводов', level: 0 },
        { name: 'ТЕХНИЧЕСКАЯ БАЗА', level: -1 },
        { name: 'TypeScript / JavaScript, React', level: 0 },
        { name: 'C# / .NET', level: 0 },
        { name: 'Работа с LLM API, промптинг', level: 0 },
        { name: 'Git, CI/CD, деплой', level: 0 },
        { name: 'ЯЗЫКИ', level: -1 },
        { name: 'Английский - чтение технической документации', level: 0 },
        { name: 'ДОПОЛНИТЕЛЬНО', level: -1 },
        { name: 'Figma, Krita - инфографика и оформление отчётов', level: 0 }
      ],
      projects: [
        { title: 'EduQuiz Pro - платформа тестирования со сбором результатов', desc: 'Конструктор тестов и режим прохождения: фиксация ответов, валидация данных на входе, автоматический подсчёт правильных и неправильных, агрегация результатов и хранение истории. По сути инструмент сбора количественных данных об аудитории. Работает онлайн.', tags: 'React, JavaScript, аналитика результатов', link: 'my-edu-quiz.vercel.app' },
        { title: 'LexiCard - приложение с метриками обучения', desc: 'Считает точность ответов, выделяет ошибочные элементы в отдельную выборку для повторного прохождения, выводит итоговую статистику и историю прогресса. Генерация наборов данных через AI API.', tags: 'React, TypeScript, метрики, Serverless', link: 'github.com/Evil-Pinguin/lexicard' },
        { title: 'Методическая аналитика в школе', desc: 'Четыре года: разработка диагностических работ, сбор и обработка результатов по выборке 200+ учеников, анализ типовых ошибок, корректировка программы по итогам. Отчётность для администрации.', tags: 'анализ результатов, отчётность, методология', link: '' },
        { title: 'Другие проекты', desc: 'Aurora - голосовой помощник для автоматизации работы за компьютером. Обучающий сайт по основам Linux. Личные веб-инструменты: то-ду лист, генератор резюме.', tags: 'Python, JavaScript, автоматизация', link: '' }
      ],
      exp: [
        { title: 'Преподаватель программирования и информатики - 2 школы допобразования', meta: '4 года', desc: 'Разработала авторские методики обучения для 4 направлений: программирование, веб-разработка, геймдев, основы Linux. Выстроила систему отслеживания прогресса для 200+ учеников: диагностические срезы, критерии оценивания, анализ типовых ошибок и корректировка методики по данным. Вела проектные работы до защиты на научных конференциях, среди учениц есть победительницы муниципальной олимпиады. Готовила отчётность для администрации.' },
        { title: 'Самостоятельные проекты: разработка аналитических веб-сервисов', meta: '2024 - настоящее время', desc: 'Разработка веб-сервисов полного цикла, включая аналитические модули: сбор, подсчёт и визуализация результатов. Работа с PostgreSQL через Supabase, обработка данных на Python и JavaScript. Это личные проекты, не коммерческие заказы.' },
        { title: 'Волонтёр международных и республиканских мероприятий', meta: 'Регулярно, несколько лет', desc: 'Игры «Дети Азии», фестиваль «Муус устар» с первого сезона, «Игры Манчаары». Координация на площадках, работа в команде, оперативные решения в меняющейся обстановке.' },
        { title: 'Педагогический институт - высшее образование', meta: 'Диплом', desc: 'Методология обучения, проектирование систем оценивания, анализ результатов и статистики успеваемости.' }
      ]
    })
  },
...
const FIELDS = {
  ...
  skills: [['name', 'Навык', 'text'], ['level', 'Уровень % (0 = без шкалы, -1 = заголовок)', 'number']],
...
function renderList(key) {
  ...
  data[key].forEach((item, i) => {
    ...
    div.querySelectorAll('[data-f]').forEach(inp => inp.addEventListener('input', () => {
      ...
      item[f] = inp.type === 'number' ? Math.max(-1, Math.min(100, +inp.value || 0)) : inp.value;
      save(); render();
    }));
...
function render() {
  ...
  const skills = data.skills.length ? `<section class="s-skills"><h2>Навыки</h2><div class="skills-grid">${data.skills.map(s => {
    ...
    if (lv === -1) return `<div class="skgroup">${esc(s.name)}</div>`;          // подзаголовок группы
    if (lv === 0) return `<div class="skplain">${esc(s.name)}</div>`;           // навык без шкалы
    return `<div class="skill"><div class="row"><b>${esc(s.name)}</b><span>${lv}%</span></div>
    <div class="bar"><i style="width:${Math.min(100, lv)}%"></i></div></div>`;
  }).join('')}</div></section>` : '';
...
document.getElementById('preset').addEventListener('change', e => {
  ...
  const pd = p.data();
  const head = Object.fromEntries(Object.entries(HEAD).filter(([k]) => !(k in pd) || k === 'name' || k === 'phone' || k === 'github'));
  data = Object.assign(pd, head, { preset: e.target.value });
  save(); boot();
});
