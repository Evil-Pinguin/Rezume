...
const DEFAULT = {
  ...
  achievements: [
    ...
    { text: 'Сделала и выпустила 4 приложения полного цикла - от архитектуры до автодеплоя. Все работают онлайн, можно открыть и посмотреть.' },
    { text: 'Подключила нейросеть через serverless-функцию: ключи спрятаны в окружении, ответ модели валидируется.' },
    { text: 'Закрываю то, что обычно делят на троих: дизайн, разработку и документацию. Меньше согласований внутри команды.' },
