...
const DEFAULT = {
  ...
  projects: [
    ...
    },
    {
      ...
      desc: 'React + TypeScript + PostgreSQL через Supabase. Форма сбора ответов с валидацией, асинхронной записью в БД, обработкой ошибок и состояний загрузки. Ключи в переменных окружения.',
  ...
  exp: [
    {
      ...
      meta: '4 года',
      desc: 'Обучила больше 200 учеников. Направления: C# и Unity, C++ (SFML), Python, веб-разработка, Roblox Studio, визуальные новеллы. Писала авторские методики и учебные материалы, смотрела уровень групп по срезам и подправляла программу под результат. Вела проектные работы до защиты, графику и спрайты для учебных игр рисовала сама.'
    },
    {
...
const PRESETS = {
  ...
  hobby: 'Рисование и цифровая графика · Разработка авторских методик · Создание сайтов · Программирование как хобби · Рукоделие · Наращивание ногтей · Свободно ориентируюсь в интернет-культуре и мемах - общий язык с подростками',
      ...
      skills: [
        ...
        { name: 'Наставничество, сопровождение проектов', level: 90 },
