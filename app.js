  ...
  research: {
    ...
    data: () => ({
      ...
      projects: [
        ...
        { title: 'Методическая аналитика в школе', desc: 'Четыре года: разработка контрольных и диагностических работ, сбор результатов по группам, анализ типовых ошибок и корректировка программы по итогам. Подготовка отчётов для администрации.', tags: 'анализ результатов, отчётность, методология', link: '' }
      ],
      exp: [
        { title: 'Преподаватель информатики и программирования — 2 школы ДО', meta: '4 года', desc: 'Диагностика уровня учеников, разработка тестов и критериев оценивания, сбор и анализ результатов групп, корректировка программы по данным. Отчётность, методические материалы, сопровождение проектных работ.' },
  ...
  qa: {
    ...
    data: () => ({
      ...
      exp: [
        ...
        { title: 'Преподаватель информатики — 2 школы ДО', meta: '4 года', desc: 'Разработка критериев оценивания и проверочных работ, детальный разбор ошибок учеников, письменная обратная связь. Навык точно описывать проблему и воспроизводить её по шагам.' },
