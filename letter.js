...
const SKILLS = [
  ...
  { n: 'Автоматизация процессов', lvl: 2, kw: ['автоматизац', 'скрипт', 'бот', 'ассистент', 'оптимизац процесс'], proof: 'написала Aurora - голосового помощника для компьютера, который автоматизирует рутинные действия пользователя' },
