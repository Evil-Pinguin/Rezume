...
function buildLetter(a) {
  ...
  const reloc = analyst ? ' Живу в Якутске, релокация не требуется.' : ($('v-relocate').checked ? ' Готова к релокации и к работе по московскому времени.' : ' Работаю удалённо, живу в Якутске, к работе по московскому времени готова.');
